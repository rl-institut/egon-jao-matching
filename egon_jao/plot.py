...
def plot_lines_comparison(lines_in_germany_original, lines_in_germany):
    ...
    lines_in_germany_original.plot(ax=axes[0], color='green', linewidth=1, transform=ccrs.Geodetic())
    ...
    lines_in_germany.plot(ax=axes[1], color='green', linewidth=1, transform=ccrs.Geodetic())

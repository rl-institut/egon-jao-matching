...
df.drop(columns=['r_allocated', 'x_allocated', 'b_allocated'], inplace=True, errors='ignore')

# 4. Keep only the specified final columns
columns_to_keep = [
    'id', 'bus0', 'bus1', 'type', 'carrier', 'x', 'r', 'g', 'b',
    's_nom', 's_nom_extendable', 's_nom_min', 's_nom_max', 's_max_pu',
    'build_year', 'lifetime', 'capital_cost', 'length', 'terrain_factor', 'num_parallel',
    'v_ang_min', 'v_ang_max', 'geom', 's_nom_mod', 'sub_network', 'v_nom',
    'x_pu', 'r_pu', 'b_pu', 'g_pu', 'x_pu_eff', 'r_pu_eff', 's_nom_opt'
]
